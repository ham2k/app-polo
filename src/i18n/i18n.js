...
const BUNDLED_LANGUAGES = ['en', 'es', 'ja', 'de', 'fr', 'it', 'pt', 'pt-BR', 'zh', 'ca', 'nl', 'sk', 'nb', 'cs', 'tr', 'ro', 'ko']
...
function readBundledJSON (language, namespace) {
  ...
  switch (`${language}/${namespace}`) {
    ...
    case 'it/translation':
      return {
        ...require('./crowdin/it/general.json'),
        ...require('./crowdin/it/polo.json'),
        ...require('./crowdin/it/extensions.json')
      }
    case 'ja/translation':
      return {
    ...
    case 'ko/translation':
      return {
        ...require('./crowdin/ko/general.json'),
        ...require('./crowdin/ko/polo.json'),
        ...require('./crowdin/ko/extensions.json')
      }
    case 'nb/translation':
      return {
    ...
    case 'tr/translation':
      return {
        ...require('./crowdin/tr/general.json'),
        ...require('./crowdin/tr/polo.json'),
        ...require('./crowdin/tr/extensions.json')
      }
    case 'zh/translation':
      return {
