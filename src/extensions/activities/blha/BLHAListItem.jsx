...
import { blhaFindOneByReference } from './BLHADataFile'

export function BLHAListItem ({ activityRef, refData, allRefs, style, styles, settings, onPress, onAddReference, onRemoveReference }) {
  const [reference, setReference] = useState()
  useEffect(() => {
    blhaFindOneByReference(activityRef).then(setReference)
  }, [activityRef])
